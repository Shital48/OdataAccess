		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comodatatestodatatestproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comodatatestodatatestproject-display": {
								"semanticObject": "comodatatestodatatestproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.odatatest.odatatestproject",
									"url": sap.ui.require.toUrl("com/odatatest/odatatestproject")
								}
							}
						}
					}
